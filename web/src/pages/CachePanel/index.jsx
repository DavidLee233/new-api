...
const CachePanel = () => {
  ...
  const summaryRows = [
    ...
    { key: t('最近更新时间'), value: stats?.updated_at ? timestamp2string(stats.updated_at) : '-' },
  ];
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Card>
                ...
                <div style={{ marginTop: 12 }}>
                  <Typography.Text>{t('读占比')} {readTokenPercent.toFixed(2)}%</Typography.Text>
                  <Progress percent={readTokenPercent} stroke='#0ea5e9' />
                </div>
                <div style={{ marginTop: 12 }}>
                  <Typography.Text>{t('写占比')} {writeTokenPercent.toFixed(2)}%</Typography.Text>
            ...
            <Col span={12}>
              <Card>
                ...
                <div style={{ marginTop: 12 }}>
                  <Typography.Text>{t('读占比')} {readReqPercent.toFixed(2)}%</Typography.Text>
                  <Progress percent={readReqPercent} stroke='#0284c7' />
                </div>
                <div style={{ marginTop: 12 }}>
                  <Typography.Text>{t('写占比')} {writeReqPercent.toFixed(2)}%</Typography.Text>
