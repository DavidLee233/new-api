...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/codex/oauth/import", controller.ImportCodexOAuthForChannel)
			...
			channelRoute.POST("/:id/antigravity/refresh", controller.RefreshAntigravityChannelCredential)
		...
		logRoute.GET("/cache_panel", middleware.UserAuth(), controller.GetCachePanelStats)
